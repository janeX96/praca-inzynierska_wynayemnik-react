...
const AdministratorLogs = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validation.correct) {
            ...
            GET(`${owner.administrators.logs}${props.administratorId}?fromDate=${fromDate}&toDate=${toDate}`)
                .then((data) => {
                    data.map((e) => {
                        e.actionType =
                            e.actionType === "INSERT"
        ...
        <div style={{width: "100%"}}>
            ...
            <div className="table-container">
                ...
                <div className="form-container" style={{display: "contents"}}>
                    <form>
                        <div className="form-container__row" style={{marginBottom: "10px"}}>
                    ...
                    <div className="form-container__buttons" style={{marginBottom: "18px", marginTop: "-10px"}}>
